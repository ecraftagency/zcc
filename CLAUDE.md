...
- Full text of all five + recorded traps: **`tests/README.md`**. Argument-offset lives in three byte-identical places (codegen call, codegen spill, parser va_off) — edit all three, then run `abi.sh`.
