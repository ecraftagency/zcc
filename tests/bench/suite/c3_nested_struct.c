...
int main(void){ int i; for(i=0;i<10000;i++){ o[i].a.lo=i; o[i].a.hi=i*2; o[i].b.lo=i-1; o[i].b.hi=i+3; o[i].tag=i&15; } long s=0,k; for(k=0;k<4000;k++) s+=work(o,10000); printf("%ld\n",s); return 0; }
